        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Job Portal</h3>
...
<script type="text/javascript">
  var dataTableRoute = "{{ route('job.adminfetch') }}";
  var editRoute = "{{route('job.admindelete')}}";
  var activeRoute = "{{route('job.adminactive')}}";
  var disableRoute = "{{route('job.admindisable')}}";
