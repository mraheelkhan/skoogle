...
@if (Route::currentRouteName()=='leads.index' or Route::currentRouteName()=='leads.search' or Route::currentRouteName()=='createappointments' or Route::currentRouteName()=='hrleads' or Route::currentRouteName()=='interviewees' or Route::currentRouteName()=='interviews'  or Route::currentRouteName()=='admins.create' or Route::currentRouteName()=='admins.edit')
  <script src="//cdnjs.cloudflare.com/ajax/libs/moment.js/2.9.0/moment-with-locales.js"></script>
